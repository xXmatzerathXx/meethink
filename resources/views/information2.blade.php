...
<div class="scroll-container">
    ...
    {!! Form::open(['url' => 'information3', 'class' => 'form-info']) !!}
        ...
        <input type="checkbox" name="virtudes[]" id="cbox6" value="perspeverancia"><label for="cbox6"><img src="{{asset('img/icons/virtudes/perseverancia.svg')}}">Perseverancia</label>
        ...
        <input type="checkbox" name="virtudes[]" id="cbox9" value="socialización"><label for="cbox9"><img src="{{asset('img/icons/virtudes/socializacion.svg')}}">Socializacion</label>
