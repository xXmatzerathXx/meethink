...
<div class="scroll-container">
    ...
    {!! Form::open(['url' => 'complete', 'class' => 'form-info']) !!}
        ...
        <span><input type="checkbox" name="skills[]" id="cbox3" value="diseñop"><label for="cbox3"><img src="{{asset('img/icons/habilidades/diseñodepersonaje.svg')}}">Diseño de Personajes</label></span>
        <span><input type="checkbox" name="skills[]" id="cbox4" value="edicion"><label for="cbox4"><img src="{{asset('img/icons/habilidades/edicion.svg')}}">Edición</label></span>
        ...
        <span><input type="checkbox" name="skills[]" id="cbox6" value="ilustracion"><label for="cbox6"><img src="{{asset('img/icons/habilidades/ilustracion.svg')}}">Ilustración</label></span>
        ...
        <span><input type="checkbox" name="skills[]" id="cbox8" value="modelado"><label for="cbox8"><img src="{{asset('img/icons/habilidades/modelado3d.svg')}}">Modelado 3D</label></span>
